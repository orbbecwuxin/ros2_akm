...
def generate_launch_description():
    ...
    MS200_dir = get_package_share_directory('oradar_lidar')
    MS200_launch_dir = os.path.join(MS200_dir, 'launch')
    ...
    MS200lidar = IncludeLaunchDescription(
            PythonLaunchDescriptionSource(os.path.join(MS200_launch_dir, 'ms200_scan.launch.py')),)
